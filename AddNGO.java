...
/**
 * AddNGO class - Allows administrators to add and manage NGOs
 * @author Hp
 */
public class AddNGO extends JFrame {
    ...
    private class Handler implements ActionListener {
        ...
        private void handleAddNGO() {
            ...
            if (idtf.getText().isEmpty()) {
                ...
                JOptionPane.showMessageDialog(null, "Please Enter Contact Number", "Warning", JOptionPane.ERROR_MESSAGE);
                ...
                JOptionPane.showMessageDialog(null, "This NGO already exists or This ID already exists");
            } else {
        ...
        /**
         * Handle updating an existing NGO
         */
        private void handleUpdateNGO() {
            if (idtf.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Please Enter ID", "Warning", JOptionPane.ERROR_MESSAGE);
            } else if (nametf.getText().isEmpty() || (!male.isSelected() && !female.isSelected()) 
                    || emailtf1.getText().isEmpty() || contacttf.getText().isEmpty() || locationtf.getText().isEmpty()) {
    ...
    /**
     * Check if NGO already exists by name and email
     */
