...
/**
 * UserView - Display user list for NGO
 * Shows all registered users with their detailed information
 * 
 * @author Team
 */
public class UserView extends JFrame {
    ...
    private void createNavigationBar() {
        ...
        assignExecutiveButton = createButton("Assign Executive", 603, 30, 250, 80, handCursor, buttonFont, navigationBar);

        // View Executive Button
        viewExecutiveButton = createButton("View Executive", 854, 30, 240, 80, handCursor, buttonFont, navigationBar);

        // View Collect Medicine Button
        viewCollectMedicineButton = createButton("View Collect Med", 1095, 30, 250, 80, handCursor, buttonFont, navigationBar);

        // Logout Button
        logoutButton = createButton("Logout", 1346, 30, 200, 80, handCursor, buttonFont, navigationBar);
    ...
    private void createSectionTitle() {
        ...
        sectionTitleLabel = new JLabel("View Users");
    ...
    /**
     * Create table section to display user information
     */
    private void createTableSection() {
        ...
        String[] columns = {"ID", "Name", "Gender", "Date of Birth", "Email", 
        ...
        userTable.setFont(tableContentFont);
        userTable.setSelectionBackground(Color.PINK);
    ...
    private void setupColumnWidths() {
        ...
        columnModel.getColumn(1).setPreferredWidth(360);    // Name
        columnModel.getColumn(2).setPreferredWidth(50);     // Gender
        columnModel.getColumn(3).setPreferredWidth(80);     // Date of Birth
        columnModel.getColumn(4).setPreferredWidth(400);    // Email
        columnModel.getColumn(5).setPreferredWidth(110);    // Contact Number
        columnModel.getColumn(6).setPreferredWidth(430);    // Location
    }
    ...
    /**
     * Load user data into table from database
     */
    private void loadTableData() {
        try {
            String sql = "SELECT `ID`, `Name`, `Gender`, `Date of Birth`, `Email`, " +
                        "`Contact Number`, `Location` FROM `userregistration`";
