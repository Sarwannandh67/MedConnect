...
/**
 * AssignExecutive class - Allows NGOs to assign users as executives
 * Provides functionality to search users, assign, update, and delete executives
 * @author Hp
 */
public class AssignExecutive extends JFrame {
    ...
    private JLabel idl, namel, genderl, agel, emaill, contactl, locationl;
    ...
    private JButton homepage, user, logout, search, assign, viewexecutive;
    private JButton viwngo, viewmed, collect, delete, update;
    ...
    private void createMainContentArea(Font font1, Cursor cursor) {
        ...
        createUserDetailsSection(font1, label1);

        // Create action buttons
        createActionButtons(font1, cursor, label1);
    }

    /**
     * Create search section with ID combo box and search button
     */
    ...
    /**
     * Create user details display section
     */
    private void createUserDetailsSection(Font font1, JLabel label1) {
     ...
     * Create action buttons
     */
    private void createActionButtons(Font font1, Cursor cursor, JLabel label1) {
    ...
    private class Handler implements ActionListener {
        ...
        /**
         * Handle search user by ID
         */
        private void handleSearchUser(String id) {
            int a = 0;
        ...
        /**
         * Handle assigning user as executive
         */
        private void handleAssignExecutive() {
            String id = idtf.getSelectedItem().toString();

            if (id.isEmpty() || nametf.getText().isEmpty() || gendertf.getText().isEmpty()
                    || agetf.getText().isEmpty() || emailtf.getText().isEmpty()
                    || contacttf.getText().isEmpty() || locationtf.getText().isEmpty()) {
        ...
        /**
         * Insert new executive into database
         */
        private void insertExecutive() {
        ...
        /**
         * Handle updating executive information
         */
        private void handleUpdateExecutive() {
            ...
            } else if (gendertf.getText().isEmpty() || agetf.getText().isEmpty()
                    || contacttf.getText().isEmpty() || locationtf.getText().isEmpty()) {
        ...
        /**
         * Update executive record in database
         */
        private void updateExecutiveInDatabase() {
         ...
         */
        private void deleteExecutiveFromDatabase() {
    ...
    /**
     * Check if user is already assigned as executive
     */
    public boolean checkusername(String username, String ema) {
        ...
        return checkuser && emailCheck;
    }

    /**
     * Load user IDs from database into combo box
     */
