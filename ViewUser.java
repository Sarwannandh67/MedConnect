...
/**
 * ViewUser - Display user list for Admin
...
public class ViewUser extends JFrame {
    ...
    private void createNavigationBar() {
        ...
        // View NGO Button
        viewNGOButton = createButton("View NGO", 773, 30, 250, 80, handCursor, buttonFont, navigationBar);

        // View Medicine Button
        viewMedicineButton = createButton("View Medicine", 1024, 30, 250, 80, handCursor, buttonFont, navigationBar);
